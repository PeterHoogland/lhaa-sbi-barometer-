...
Onzekerheid is geen niveau en krijgt dus geen eigen kicker én geen waarschuwingszin; ze blijft zichtbaar via de 90%-band in de meter en de sobere bandbreedte-regel onder het cijfer, in élke vlagtoestand dezelfde vorm (bij `thin_reference` "indicatief" in plaats van de "90% zeker"-claim: het interval dekt die onzekerheid juist niet). De oorspronkelijke B3-weergave (bereik in plaats van getal, kicker "ONZEKER" bij high), de tussenvorm met de zin "De meting is vandaag onzeker: …", en de eerdere absolute woordenschat (LAAG/GEMIDDELD/VERHOOGD/EXTREEM) zijn hiermee vervangen; de data-velden zijn ongewijzigd.
