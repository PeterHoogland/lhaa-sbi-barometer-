    ...
    <section className="panel methodology">
      ...
      <details>
        ...
        <ol className="methodology-steps">
          ...
          <li>Het hoofdcijfer vergelijkt de structurele indicatoren (kosten van levensonderhoud, energie) met het decennium 2010-2019, en de dagelijkse omstandigheden (weer, nieuws, verkeer) met hun eigen normaal. De tweede lens (de kern van de meting) vergelijkt met de afgelopen twee jaar; die vergelijking is nu nog "voorlopig" en rust op maximaal twee jaar historie. Zodra een indicator drie jaar seizoenshistorie heeft, schakelt hij over op een nauwkeurigere methode (empirische verdelingsfunctie, dezelfde als de ECB-stressindex CISS). Per indicator zie je in de data welke methode geldt.</li>
          <li>We corrigeren voor seizoens-effecten waar dat zinvol is (bv. files in juli zijn anders dan files in november).</li>
          <li>Het hoofdcijfer combineert de structurele druk (kosten van levensonderhoud en energie, gemeten tegen 2010-2019) met de omstandigheden van vandaag (weer, nieuws, verkeer); de dagelijkse beweging weegt voor ongeveer 30% mee. Daarnaast berekenen we controleversies, onder meer een variant waarin sterker onderbouwde indicatoren zwaarder wegen; wijkt die sterk af, dan is dat voor ons een waarschuwingssignaal. Hoe sterk het onderzoek achter elke indicator is, zie je per indicator bij "Bewijskracht".</li>
