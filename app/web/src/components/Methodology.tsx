  ...
  return (
    <section className="panel methodology">
      ...
      <ul className="methodology-do-dont">
        <li><strong>Wat we doen:</strong> we kijken naar 6 thema's en 25 elementen die met stress te maken hebben, en tellen hoe ongewoon ze vandaag zijn.</li>
      ...
      <details>
        ...
        <ol className="methodology-steps">
          <li>We tellen 25 indicatoren, verdeeld over 6 categorieën (weer, verkeer, economie, werk/gezin, nieuws, kalender).</li>
