    ...
    <section className="panel methodology">
      ...
      <details>
        ...
        <ol className="methodology-steps">
          ...
          <li>Het hoofdcijfer vergelijkt de structurele indicatoren (kosten van levensonderhoud, energie) met het decennium 2010-2019, en de dagelijkse omstandigheden (weer, nieuws, verkeer en openbaar vervoer) met hun eigen normaal. De tweede lens (de kern van de meting) vergelijkt met de afgelopen twee jaar; die vergelijking is nu nog "voorlopig" en rust op maximaal twee jaar historie. Zodra een indicator drie jaar seizoenshistorie heeft, schakelt hij over op een nauwkeurigere methode (empirische verdelingsfunctie, dezelfde als de ECB-stressindex CISS). Per indicator zie je in de data welke methode geldt.</li>
