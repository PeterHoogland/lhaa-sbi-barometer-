  ...
  return (
    <section className="panel methodology">
      ...
      <ul className="methodology-do-dont">
        ...
        <li><strong>Hoe vergelijken we?</strong> Het hoofdcijfer meet de druk van vandaag tegen normale tijden: het decennium 2010-2019, waar 50 het normale niveau is. Daarnaast tonen we een tweede lens (de kern van de meting) die juist met de afgelopen twee jaar vergelijkt.</li>
      </ul>
      ...
      <details>
        ...
        <ol className="methodology-steps">
          ...
          <li>Het hoofdcijfer vergelijkt de structurele indicatoren (kosten van levensonderhoud, energie) met het decennium 2010-2019, en de dagelijkse omstandigheden (weer, nieuws, verkeer en openbaar vervoer) met hun eigen normaal. De tweede lens (de kern van de meting) vergelijkt met de afgelopen twee jaar; die vergelijking is nu nog "voorlopig" en rust op maximaal twee jaar historie. Zodra een indicator drie jaar seizoenshistorie heeft, schakelt hij over op een nauwkeurigere manier van vergelijken, dezelfde die de Europese Centrale Bank voor haar stress-index CISS gebruikt. Per indicator zie je in de data welke methode geldt.</li>
          <li>We corrigeren voor seizoens-effecten waar dat zinvol is (bv. files in juli zijn anders dan files in november).</li>
          <li>Het hoofdcijfer combineert de structurele druk (kosten van levensonderhoud en energie, gemeten tegen 2010-2019) met de omstandigheden van vandaag (weer, nieuws, verkeer en openbaar vervoer); de dagelijkse beweging weegt voor ongeveer 30% mee. Daarnaast berekenen we controleversies, onder meer een variant waarin sterker onderbouwde indicatoren zwaarder wegen; wijkt die sterk af, dan is dat voor ons een waarschuwingssignaal. Hoe sterk het onderzoek achter elke indicator is, zie je per indicator bij "Bewijskracht".</li>
          <li>Het <strong>campagne-venster</strong> (los van het cijfer) opent zodra de dag boven de drempel zit: hoger dan 70% van de dagen rond deze tijd van het jaar, gemeten over de laatste twee jaar. Zakt de dag eronder, dan sluit het venster ook weer dezelfde dag.</li>
